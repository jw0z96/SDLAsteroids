...
int main(int argc, char * argv[])
{
    ...
    SDL_Window *window=SDL_CreateWindow("Asteroids Test",
    ...
    while(!quit)
    {
        ...
        //Calculate time step on input
        timeStep = SDL_GetTicks() - timeStep;

        //scene update
        scene.updateHandler(timeStep);

        //Calculate time step on output
